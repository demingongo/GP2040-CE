...
#define BOARD_CONFIG_LABEL "Pico2EspBridge"
...
// GPIO 20 and 21 are UART1 TX/RX on RP2040/RP2350 — reassigned from A1/A2 to the UART bridge addon.
// A1 (Guide/Home/PS) and A2 (Capture) buttons are not available on this board variant.
#define GPIO_PIN_20 GpioAction::ASSIGNED_TO_ADDON   // UART1 TX → ESP32 RX
#define GPIO_PIN_21 GpioAction::ASSIGNED_TO_ADDON   // UART1 RX → ESP32 TX
...
// GPIO 26 and 27 are UART1 CTS/RTS (flow control), NOT TX/RX — do not use for data.
// Left undefined (same as stock Pico2 config).
#define GPIO_PIN_28 GpioAction::ASSIGNED_TO_ADDON

// ESP32 UART Bridge addon — UART1 on GPIO 20 (TX) / 21 (RX) at 1 Mbaud
